...
void interactions_monaghan(particle_gpu *particles,  int *cell_start,  int *cell_end, int num_cell);
void interactions_heat_pse(particle_gpu *particles,  int *cell_start,  int *cell_end, int num_cell);
